...
### Generated Insight Images

{/* Replace with actual images once downloaded from NotebookLM */}
{/* Example format:
<ZoomImage client:load src="/mapthewild/images/notebooklm-islamic-narrative/insight-1-narrative-structures.jpeg" alt="Comparison of Western vs. Arabic narrative structures" />
*/}

### Source Document Analysis

A detailed PDF analysis of how Islamic philosophy and Arabic storytelling traditions address each of these 16 questions:

{/* Replace with actual PDFs once downloaded from NotebookLM */}
{/* Example format:
<iframe src="/mapthewild/images/notebooklm-islamic-narrative/notebooklm-analysis-complete.pdf" width="100%" height="700px"></iframe>
*/}
